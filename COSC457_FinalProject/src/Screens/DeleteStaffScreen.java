...
public class DeleteStaffScreen extends JFrame{
    ...
    public DeleteStaffScreen(String eid) {
        super("Rectangle");
        setTitle("Delete Staff Information");
        setSize(425, 350);
        ...
        JButton processBtn = new JButton("Confirm Deletion");
                ...
                class ButtonListener implements ActionListener {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            String query = ("DELETE FROM Staff WHERE EID = " + eid + ";");
